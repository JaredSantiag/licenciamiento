...
import com.cja.licenciamiento.dto.ErrorDetalles;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(LicenciamientoAppException.class)
	public ResponseEntity<ErrorDetalles> manejarSialAppException(LicenciamientoAppException exception, WebRequest webRequest){
		ErrorDetalles errorDetalles = new ErrorDetalles(new Date(), exception.getMessage(), webRequest.getDescription(false));
